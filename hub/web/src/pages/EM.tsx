...
import { api, CycleRow, fmtClock, fmtHuman, fmtMs, fmtSec, fmtSince, SeqConfig, stateColor, StepStat, STATE_LABEL, STATE_ORDER, Utilization, winLabel } from "../api";
      ...
      {steps.map((st, i) => {
        ...
        return (
          <div className="row" key={i} title={st.description}>
            ...
            {/* seconds like the total in the header: a waterfall only works
                if the parts visibly add up to the whole */}
...
function Availability({ l, s, e }: P) {
  ...
  const util = downs.data.utilization;
        ...
        {!live ? (
          ...
          <>
            <div className="kvgrid">
              ...
              <KV k="Step active" v={fmtHuman(live.step_active_ms)} mono />
